  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ApplicantsRow:
            return ApplicantsRow(data);
          case LecturesRow:
            return LecturesRow(data);
          case SectionsRow:
          ...
          case CoursereviewsRow:
            return CoursereviewsRow(data);
          case JobapplicationsRow:
            return JobapplicationsRow(data);
          case CoursesRow:
            return CoursesRow(data);
          case ConversationsRow:
            return ConversationsRow(data);
          case CompanyreviewsRow:
            return CompanyreviewsRow(data);
          case PurchasedcourseRow:
            return PurchasedcourseRow(data);
          case InternshipsRow:
            return InternshipsRow(data);
          case JobsRow:
            return JobsRow(data);
          case ShopRow:
            return ShopRow(data);
          ...
          case UsergeneratedcontentRow:
            return UsergeneratedcontentRow(data);
          case InternshipapplicationsRow:
            return InternshipapplicationsRow(data);
          case FavoritesRow:
            return FavoritesRow(data);
          case InstructorsRow:
            return InstructorsRow(data);
          case BlogsRow:
            return BlogsRow(data);
          case EventsRow:
