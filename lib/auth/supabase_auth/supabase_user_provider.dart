...
class SkillconnecttSupabaseUser extends BaseAuthUser {
  SkillconnecttSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> skillconnecttSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SkillconnecttSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
