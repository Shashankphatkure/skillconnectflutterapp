            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0x73B966E7), Color(0xAA2F57EF)],
                  stops: [0.0, 1.0],
                    ...
                    FutureBuilder<List<CoursesRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CoursesRow> listViewCoursesRowList =
                            snapshot.data!;
                        if (listViewCoursesRowList.isEmpty) {
                          return Image.asset(
                            '',
                          );
                        }
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          listViewCoursesRow.description,
                                          'description',
                                        ).maybeHandleOverflow(
                                          maxChars: 120,
                                          replacement: '…',
